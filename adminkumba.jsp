...
<html>
<head>
<title>Over all Kumbakonam Election Result</title>
<meta charset="UTF-8">
...
<div id="content">
  <div>
    <h3 align="center">Over all Kumbakonam Election Result</h3>    
    
    <table align="center" border="1" style="color:white">
					<tr>
					<th style="color:black;">Name</th>
					<th style="color:black;">Athaar Number</th>
					<th style="color:black;">Kumarasami</th>
					<th style="color:black;">Mohankumar</th>
					<th style="color:black;">Parimelan</th>
					<th style="color:black;">Moorthi</th>
					<th style="color:black;">Ananthan</th>
					<th style="color:black;">Eswaran</th>
					<% 
						//String a,b,c,d,e,f,g;
						Class.forName("com.mysql.jdbc.Driver");
						Connection con=DriverManager.getConnection("jdbc:mysql://localhost/online","root","root");
						PreparedStatement query=con.prepareStatement("select * from kumbakonam");
