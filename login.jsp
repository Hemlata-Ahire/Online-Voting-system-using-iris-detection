...
<div class="main">   
  <div class="header">
    <div class="header_resize">
      ...
      <p align="center">Aadhaar Number &nbsp;&nbsp;<input type="text" style="color:blue" name="athaar"></input></p>
      <p align="center">Password&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <input type="password" style="color:blue" name="password"></input></p>
      <p align="center"><input type="submit" value="Login" style="weight:200px; height:30px;"></input></p></form>  
      <br></br><br></br><br /><br>
      <div class="clr">
      </div>
      </div>
